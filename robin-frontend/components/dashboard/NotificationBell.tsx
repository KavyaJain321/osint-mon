...
function getSeedNotifications(): Notification[] {
    return [
        ...
        },
        {
            ...
            body: "Batch analysis run finished. 7 articles processed, 20 entities profiled, 6 signals generated.",
        ...
        },
        {
            ...
            body: "Your morning situation digest is ready. 3 new developments since last review.",
