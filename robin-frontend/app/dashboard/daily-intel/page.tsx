...
<div class="header-band">
  <div class="subtitle">Government of Odisha · Intelligence Wing · For Official Use Only</div>
  <h1>Daily Situation Report</h1>
  <div class="meta">${dateLabel} · Generated by ROBIN Intelligence System · ${now} IST</div>
...
<!-- FOOTER -->
<div class="footer">
  <span>ROBIN Intelligence System · Government of Odisha · FOR OFFICIAL USE ONLY</span>
...
function TopNewsSection({ articles, reviewedIds, onReview }: {
    ...
    const top10 = [...articles].sort((a, b) => (b.importance_score || 0) - (a.importance_score || 0)).slice(0, 10);
    ...
    if (enriched.length === 0) {
        return (
            <div className="px-5 py-8 text-center">
                ...
                <div className="text-sm text-slate-500">No entity intelligence available for this date.</div>
                            ...
                            <div className="px-5 pb-4 space-y-3 border-t border-slate-700/30 pt-3">
                                ...
                                {entity.relevance_reason && (
                                    <div className="bg-slate-800/60 border border-slate-700/40 rounded px-3 py-2">
                                        <div className="text-2xs font-mono text-slate-500 uppercase tracking-wider mb-1">Intelligence Note</div>
        ...
        <div className="flex flex-col h-full overflow-hidden">
            ...
            <div className="flex-1 overflow-y-auto">
                <div className="max-w-7xl mx-auto px-6 py-5 space-y-4">
                        ...
                        <div className="flex items-start justify-between gap-4">
                            <div className="flex-1">
                                <div className="flex items-center gap-2 mb-1">
                                    <span className="text-2xs font-mono text-slate-500 uppercase tracking-widest">Government of Odisha · Intelligence Wing</span>
                                ...
                                <p className="text-xs text-slate-400 mb-3">Prepared by ROBIN Intelligence System · Last refreshed {lastRefreshed.toLocaleTimeString("en-IN")}</p>
                    ...
                    {/* Entity Intelligence Network */}
                    <SectionCard
                        title="Entity Intelligence Network"
                        icon={<Users size={15} />}
